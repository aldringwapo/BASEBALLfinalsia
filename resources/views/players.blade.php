...
<body>
    <div class="container">
        <div class="d-flex justify-content-between align-items-center header-buttons p-4">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            <div class="qr-code">
                                {!! QrCode::size(70)->generate(Request::url() . '/players/' . $player->id) !!}
                            </div>
                            <img src="{{ $player->photo_url }}" alt="{{ $player->name }}" class="baseball.jpg">
                            <h5 class="card-title mt-3">{{ $player->name }}</h5>
                            <p class="card-text">Jersey Number: {{ $player->jerseynumber }}</p>
